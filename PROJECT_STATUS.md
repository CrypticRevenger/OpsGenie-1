...
_Last updated: 2026-07-19 (Edit / correction / data-management: undo/void, edit invoice/payment, edit dealer/supplier, stock-take)_
...
- [ ] **Confirm production is redeployed** with the latest `master` and that Alembic migrations have been run on the Neon prod DB (it's a manual/one-shot step; local DB is at head `d5f9b3e7a614`).

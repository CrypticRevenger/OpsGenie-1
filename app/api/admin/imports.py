...
@router.post(
    ...
    summary="Import a CSV/Excel file of invoices or payments",
    description=(
        "Accepts a Tally, Vyapar, or OpsGenie-canonical CSV/Excel export. "
        "One bad row never fails the whole file — failures are reported per row, "
        "not raised. Re-uploading the same file is safe (idempotent)."
    ),
)

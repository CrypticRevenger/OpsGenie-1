...
• edit dealer (या /edit_dealer) — phone, credit limit, terms, GSTIN, या direct reminders बदलें
...
*डीलर Self-Service*
• enable dealer self-service / disable dealer self-service — अपने डीलरों को इस नंबर पर सीधे \
अपना balance चेक करने दें (डिफ़ॉल्ट रूप से off)
...
MESSAGES: dict[str, str] = {
    ...
    "onboarding.import_confirm.title": "📋 आपके import से कुछ डेटा मिला:",
    "onboarding.import_confirm.line_products": "✅ {count} प्रोडक्ट्स",
    "onboarding.import_confirm.line_dealers": "✅ {count} डीलर",
    "onboarding.import_confirm.line_suppliers": "✅ {count} सप्लायर",
    ...
    "onboarding.import_confirm.ask": "क्या यह सही है? (yes/no)",
    "onboarding.import_confirm.no_ack": (
        "कोई बात नहीं — आप इसे कभी भी ठीक कर सकते हैं: 'edit dealer <name>', "
        "'edit supplier <name>', 'add dealer', 'add supplier', या 'stock take' से "
        "product quantity बदलें। आपका बाकी सेटअप जारी है।"
    ),
    ...
    "workflow.busy_reply_first": (
        "पहले इसका reply दें, फिर आप अपना अगला message भेज सकते हैं।\n\n{question}"
    ),
    "workflow.unsupported_message_type": (
        "माफ़ करें, मैं अभी सिर्फ़ text message, photo, और voice note का reply दे सकता हूं। कृपया अपना "
        "message टाइप करें।"
    ),
    "workflow.voice_transcribed": '🎙️ मैंने सुना: "{transcript}"',
    "workflow.voice_unreadable": (
        "माफ़ करें, मैं वो voice note समझ नहीं पाया। कृपया दोबारा कोशिश करें, या अपना message टाइप करें।"
    ),
    "workflow.voice_download_failed": (
        "मैं अभी वो voice note download नहीं कर पाया। कृपया थोड़ी देर में दोबारा भेजें, या अपना message "
        "टाइप करें।"
    ),
    # ── Record payment ─────────────────────────────────────────────────────
    ...
    "payment.method_ask": "Cash या Online? कृपया 1 Cash या 2 Online reply करें।",
    "payment.method_invalid": "कृपया 1 Cash या 2 Online reply करें।",
    "payment.date_ask": (
    ...
    "order.advance_amount_ask": "Dealer ने advance में कितना दिया? (जैसे 5000)",
    "order.advance_amount_invalid": "कृपया zero से ज़्यादा number भेजें, जैसे 5000।",
    "order.advance_exceeds_total": (
        "यह order के {total} total से ज़्यादा है। कम amount भेजें, या बिना advance के order "
        "बनाने के लिए YES reply करें।"
    ),
    "order.preview_header": "{dealer} के लिए order confirm करें:",
    "order.preview_footer": (
        "Reply YES बनाने के लिए, NO cancel के लिए, या ADVANCE अगर dealer ने पहले से कुछ pay कर दिया है।"
    ),
    ...
    "order.new_product_gst_ask": (
        "इस company का GST product के हिसाब से अलग-अलग है, इसलिए '{product}' के लिए अपना "
        "GST% चाहिए। Rate क्या है? (जैसे 5, 12, 18)"
    ),
    "order.existing_product_gst_ask": (
        "इस company का GST product के हिसाब से अलग-अलग है, और '{product}' का अभी कोई rate "
        "set नहीं है। इसका GST% क्या है? (जैसे 5, 12, 18)"
    ),
    "order.existing_product_gst_save_ask": (
        "{rate}% को '{product}' का GST rate आगे के orders के लिए save करें? YES reply करें "
        "save करने के लिए, NO सिर्फ़ इस order के लिए।"
    ),
    "order.existing_product_gst_saved": "✅ Saved — '{product}' का GST rate अब {rate}% है।",
    "order.existing_product_gst_not_saved": (
        "ठीक है — इस order के लिए {rate}% use कर रहे हैं ('{product}' में save नहीं हुआ)।"
    ),
    ...
    "party.edit.field_prompt_dealer": (
        "क्या edit करना है — phone, credit limit, payment terms, GSTIN, marketing opt-in, या "
        "direct reminders? Reply करें 'phone', 'credit limit', 'payment terms', 'gstin', "
        "'marketing', या 'reminders'।"
    ),
    "party.edit.field_invalid_dealer": (
        "कृपया reply करें 'phone', 'credit limit', 'payment terms', 'gstin', 'marketing', या "
        "'reminders' — या 'cancel'।"
    ),
    ...
    "party.edit.direct_reminders_ask": (
        "{name} के direct reminders अभी {current} हैं। Reply करें 'yes'/'enable' या "
        "'no'/'disable'।"
    ),
    "party.edit.direct_reminders_invalid": (
        "कृपया reply करें 'yes'/'enable' या 'no'/'disable', या 'cancel'।"
    ),
    ...
    "notify.supplier_reminder_more_bills": (
        "इस supplier के {count} और bill(s) भी open हैं, कुल {amount}।"
    ),
    ...
    "reminder_confirm.ask_paid": (
        "क्या आपने {supplier} को {amount} pay कर दिया है?\n"
        "Reply 1 अगर हाँ, 2 अगर अभी तक नहीं किया।"
    ),
    "reminder_confirm.switched_to": "🔄 {supplier} के reminder पर switch किया ({amount}):",
    ...
    "reminder_confirm.amount_ask": (
        ...
        "या 'ok' confirm करने के लिए।"
    ),
    "reminder_confirm.amount_invalid": "कृपया एक amount भेजें, जैसे 25000।",
    "reminder_confirm.amount_positive": "कृपया zero से ज़्यादा amount भेजें।",
    "reminder_confirm.reschedule_ask": (
        "ठीक है — इस reminder को reschedule करने के लिए नई date reply करें (जैसे 'tomorrow', "
        "'next week', '3 days'), या 'skip' अगर अभी भी due रखना है — मैं फिर से याद दिलाऊंगा।"
    ),
    "reminder_confirm.reschedule_invalid": (
        "वह date समझ नहीं आई। Try 'tomorrow', 'next week', '3 days' — या 'skip'।"
    ),
    "reminder_confirm.rescheduled": (
        "ठीक है — {supplier} का payment अब {date} को due है। उस समय के करीब फिर से याद "
        "दिलाऊंगा।"
    ),
    "reminder_confirm.kept_due": "ठीक है, मैं फिर से याद दिलाऊंगा।",
    "reminder_confirm.invoice_gone": "वह bill अब open नहीं है — reschedule करने की ज़रूरत नहीं।",
    "notify.dealer_alert": (
        "⚠ Collection Alert\n\n"
    ...
    "notify.dealer_direct_reminder": (
        "नमस्ते {dealer}, यह {business} की ओर से एक याद दिलाना है — {amount} का payment "
        "{days} दिन पहले due था। कृपया जल्द से जल्द payment करें। धन्यवाद!"
    ),
    ...
    "notify.cash_shortage_forecast": (
        ...
        "Cash ~{days} दिन में negative होने का अनुमान है।\n\n"
        "सबसे बड़ा upcoming payment: {supplier} — {amount} ({trigger_days} दिन में due)\n\n"
        "Expected out (7d): {expected_out}\n"
        "Expected in (7d, cash on hand सहित): {expected_in}"
    ),
    "notify.stock_out_forecast": (
        "📦 Stock Alert\n\n"
        "{product} current sales pace पर ~{days} दिन में खत्म हो सकता है।"
    ),
    "notify.predue_nudge": (
        "🔔 Due Soon\n\n"
        "{dealer}\n"
        ...
        "• अगर already मिल चुका है, reply करें: record payment"
    ),
    "briefing.watch.header": "⚠ इस हफ्ते ध्यान दें",
    "briefing.watch.cash_shortage": "• ~{days} दिन में cash shortage — मुख्य रूप से {supplier} {amount}",
    "briefing.watch.stock_out": "• {product} ~{days} दिन में खत्म हो सकता है",
    "briefing.watch.predue": "• {dealer} का payment {days} दिन में due है",
    ...
    "dealer.balance.header": "नमस्ते {dealer_name}, {business_name} के साथ आपका account:",
    "dealer.balance.outstanding": "💰 {amount} outstanding",
    "dealer.balance.no_outstanding": "✅ कोई outstanding balance नहीं है",
    "dealer.balance.next_due": "📅 अगला due: {date}",
    "dealer.balance.last_payment": "🧾 आखिरी payment: {amount} ({date} को)",
    "dealer.statement.ready": (
        "आपका {business_name} के साथ account statement ({period}) तैयार है।\nDownload "
        "({ttl} min valid):\n{links}"
    ),
    "dealer.statement.not_configured": (
        "माफ़ कीजिए, अभी statement उपलब्ध नहीं है — कृपया सीधे {business_name} से contact करें।"
    ),
    "dealer.help": (
        "मैं इनमें मदद कर सकता हूं:\n\nBALANCE — अपना outstanding balance चेक करें\nSTATEMENT — "
        "अपना account statement चेक करें (PDF/Excel)\nHELP — यह message फिर से देखें"
    ),
    "dealer.unrecognized": (
        "माफ़ कीजिए, मुझे यह समझ नहीं आया। अपना outstanding चेक करने के लिए BALANCE, या और "
        "जानकारी के लिए HELP reply करें।"
    ),
    "dealer.ambiguous_number": (
        "यह नंबर OpsGenie पर एक से ज़्यादा business से जुड़ा है। कृपया सीधे अपने distributor से "
        "contact करें।"
    ),
    "settings.dealer_self_service_enabled": (
        "✅ Dealer self-service अब ON है — आपके डीलर अब इस नंबर पर सीधे text करके अपना balance "
        "चेक कर सकते हैं।"
    ),
    "settings.dealer_self_service_disabled": "Dealer self-service अब OFF है।",
}

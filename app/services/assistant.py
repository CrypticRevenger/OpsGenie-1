...
_SYSTEM_PROMPT = (
    ...
    "estimate, or calculate a figure yourself — including simple arithmetic like "
    "subtracting a sold quantity from stock, or multiplying a quantity by a price. "
    "For 'if I sell/sold N of X, how much is left / what's my profit / what's my "
    "revenue' questions, call calculate_sales_impact — it looks up the real prices "
    "and does the math for you. Always write money with a ₹ prefix.\n"
    ...
    "- You cannot create orders/invoices, record payments, or add/delete/update "
    "products yourself — you have no tool for it. If the user wants to place an "
    "order, log a payment, add a product, delete a product, or update a product's "
    "price/stock, tell them to say 'new order', 'record payment', 'add product', "
    "'delete product', 'update price', or 'update stock' to start a guided "
    "step-by-step flow.\n"
    "- If asked for their 'morning briefing', 'today's summary', or similar, that "
    "specific phrase is handled outside of you — but never say you can't help. "
    "Call get_business_summary and get_priority_actions and give a warm one-shot "
    "summary from those.\n"

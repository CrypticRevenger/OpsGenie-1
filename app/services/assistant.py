...
_SYSTEM_PROMPT = (
    ...
    "- You cannot create orders/invoices, record payments, or add/delete products "
    "yourself — you have no tool for it. If the user wants to place an order, log a "
    "payment, add a product, or delete a product, tell them to say 'new order', "
    "'record payment', 'add product', or 'delete product' to start a guided "
    "step-by-step flow.\n"

...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "entity_type",
            sa.Enum("dealer", "supplier", name="activityentitytype", create_constraint=True),
            nullable=False,
        ),
    ...
    op.create_index(
        "ix_activity_timelines_company_timestamp",
        "activity_timelines",
        ["company_id", "event_timestamp"],
        unique=False,
    )
    op.create_table(
        "business_events",
    ...
    op.create_index(
        "ix_business_events_company_created",
        "business_events",
        ["company_id", "created_at"],
        unique=False,
    )
    op.create_index(
        "ix_business_events_company_type",
        "business_events",
    ...
    op.create_index(
        "ix_morning_briefings_company_sent",
        "morning_briefings",
        ["company_id", "sent_at"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "direction",
            sa.Enum("receivable", "payable", name="invoicedirection", create_constraint=True),
            nullable=False,
        ),
        ...
        sa.Column(
            "source",
            sa.Enum("csv_import", "whatsapp", name="invoicesource", create_constraint=True),
            nullable=False,
        ),
        sa.Column(
            "updated_at",
    ...
    op.create_index(
        "ix_invoices_company_due_date", "invoices", ["company_id", "due_date"], unique=False
    )
    op.create_index("ix_invoices_company_id", "invoices", ["company_id"], unique=False)
    op.create_index(
        "ix_invoices_company_status", "invoices", ["company_id", "status"], unique=False
    )
    op.create_table(
        "invoice_items",
    ...
    op.create_table(
        ...
        sa.Column(
            "source",
            sa.Enum("csv_import", "whatsapp", name="paymentsource", create_constraint=True),
            nullable=False,
        ),
        sa.Column("id", sa.Uuid(), nullable=False),
        sa.Column(
